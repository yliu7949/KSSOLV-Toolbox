classdef QABRedoButton < matlab.ui.internal.toolstrip.impl.QABPushButton
    %QABRedoButton 自定义图标的 QAB 重做按钮

    % 修改自 matlab.ui.internal.toolstrip.qab.QABRedoButton
    ...
    methods (Access = private)
        function setPropertyDefaults(this)
            ...
            % Set Icon property
            action.Icon = matlab.ui.internal.toolstrip.Icon('redo');
            action.QuickAccessIcon = matlab.ui.internal.toolstrip.Icon('redo');
