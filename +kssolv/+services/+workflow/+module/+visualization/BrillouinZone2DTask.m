classdef BrillouinZone2DTask < kssolv.services.workflow.module.AbstractTask
    ...
    methods
        ...
        function context = executeTask(~, context, ~)
            ...
            reciprocalLattice = seekpath.utils.getReciprocalCellRows(context("molecule").supercell);
